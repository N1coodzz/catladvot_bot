...
def main_menu(role: Role | str | None = None) -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="🧰 Полезная штука"), KeyboardButton(text="⚙️ Настройки")],
        ],
...
def schedule_menu_keyboard(role: Role | str | None = None) -> ReplyKeyboardMarkup:
    ...
    rows = [
        ...
        [KeyboardButton(text="👥 Общий график"), KeyboardButton(text="💞 Совместное время")],
    ]
...
def utilities_menu_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="🌤 Погода"), KeyboardButton(text="💡 Идея для вечера")],
            [KeyboardButton(text="💌 Тёплое сообщение"), KeyboardButton(text="🧺 Мини-чеклист")],
